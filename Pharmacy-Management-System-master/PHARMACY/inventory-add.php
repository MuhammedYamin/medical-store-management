...
<body>
	...
	<div class="sidenav">
			<h2 style="font-family:Arial; color:white; text-align:center;">Store Management System </h2>
			<p style="margin-top:-20px;color:white;line-height:1;font-size:12px;text-align:center">Developed by, Mohil Bhadja, 2022</p>
			<a href="adminmainpage.php">Dashboard</a>
			<button class="dropdown-btn">Inventory
			<i class="down"></i>
			</button>
			<div class="dropdown-container">
				<a href="inventory-add.php">Add New Item</a>
			...
			<div class="dropdown-container">
				<a href="stockreport.php">Item - Low Stock</a>
				<a href="expiryreport.php">Item - Soon to Expire</a>
	...
	<div class="one">
		<div class="row">
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					<p>
						<label for="medid">ITEM ID:</label><br>
						<input type="number" name="medid">
					</p>
					<p>
						<label for="medname">ITEM Name:</label><br>
	...
	<?php
		...
		if(mysqli_query($conn, $sql)){
			echo "<p style='font-size:8;'>Item details successfully added!</p>";
		} else{
